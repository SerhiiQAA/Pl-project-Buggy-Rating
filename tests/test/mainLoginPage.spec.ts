...
test.describe('Login Validation', () => {
    ...
    test('Login with valid data / TC 1', async () => {
        ...
        // Перевірка наявності "Logout" кнопки після успішного входу
    ...
    test('Login with empty Login field / TC 2', async () => {
        ...
        // Перевірка повідомлення про заповнення поля "Login"
    ...
    test('Login with empty Password field / TC 3', async () => {
        ...
        // Перевірка повідомлення про заповнення поля "Password"
    ...
    test('Login with invalid data / TC 5', async () => {
        ...
        // Перевірка повідомлення про помилкові логін/пароль
